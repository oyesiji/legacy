...
public class ColumnChartTag extends UIComponentELTag {
	...
	private javax.el.ValueExpression _titleX;
	private javax.el.ValueExpression _titleY;
	private javax.el.ValueExpression _labelFunctionX;
	private javax.el.ValueExpression _labelFunctionY;
	...
	public void release(){
		...
		this._titleX = null;
		this._titleY = null;
		this._labelFunctionX = null;
		this._labelFunctionY = null;
	...
	protected void setProperties(UIComponent comp){
		...
		org.primefaces.component.chart.column.ColumnChart component = null;
		try {
			component = (org.primefaces.component.chart.column.ColumnChart) comp;
		...
		if(_titleX != null) {
			component.setValueExpression("titleX", _titleX);
		}
		if(_titleY != null) {
			component.setValueExpression("titleY", _titleY);
		}
		if(_labelFunctionX != null) {
			component.setValueExpression("labelFunctionX", _labelFunctionX);
		}
		if(_labelFunctionY != null) {
			component.setValueExpression("labelFunctionY", _labelFunctionY);
		}
	...
	public String getComponentType() {
		return ColumnChart.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.primefaces.component.chart.ColumnChartRenderer";
	}
	...
	public void setTitleX(javax.el.ValueExpression expression){
		this._titleX = expression;
	}

	public void setTitleY(javax.el.ValueExpression expression){
		this._titleY = expression;
	}

	public void setLabelFunctionX(javax.el.ValueExpression expression){
		this._labelFunctionX = expression;
	}

	public void setLabelFunctionY(javax.el.ValueExpression expression){
		this._labelFunctionY = expression;
	}

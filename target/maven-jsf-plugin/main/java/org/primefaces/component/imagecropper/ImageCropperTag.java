...
public class ImageCropperTag extends UIComponentELTag {
	...
	protected void setProperties(UIComponent comp){
		...
		org.primefaces.component.imagecropper.ImageCropper component = null;
		try {
			component = (org.primefaces.component.imagecropper.ImageCropper) comp;
	...
	public String getComponentType() {
		return ImageCropper.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.primefaces.component.ImageCropperRenderer";
	}

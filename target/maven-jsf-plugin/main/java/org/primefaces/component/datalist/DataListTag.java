...
public class DataListTag extends UIComponentELTag {
	...
	private javax.el.ValueExpression _itemType;
	...
	protected void setProperties(UIComponent comp){
		...
		org.primefaces.component.datalist.DataList component = null;
		try {
			component = (org.primefaces.component.datalist.DataList) comp;
		...
		if(_itemType != null) {
			component.setValueExpression("itemType", _itemType);
		}
		if(_paginator != null) {
	...
	public void setItemType(javax.el.ValueExpression expression){
		this._itemType = expression;
	}

...
public class InputMaskTag extends UIComponentELTag {
	...
	private javax.el.ValueExpression _mask;
	private javax.el.ValueExpression _placeHolder;
	...
	protected void setProperties(UIComponent comp){
		...
		org.primefaces.component.inputmask.InputMask component = null;
		try {
			component = (org.primefaces.component.inputmask.InputMask) comp;
		...
		if(_mask != null) {
			component.setValueExpression("mask", _mask);
		}
		if(_placeHolder != null) {
			component.setValueExpression("placeHolder", _placeHolder);
		}
	}
	...
	public String getRendererType() {
		return "org.primefaces.component.InputMaskRenderer";
	}
	...
	public void setMask(javax.el.ValueExpression expression){
		this._mask = expression;
	}

	public void setPlaceHolder(javax.el.ValueExpression expression){
		this._placeHolder = expression;
	}

...
public class HotkeyTag extends UIComponentELTag {
	...
	protected void setProperties(UIComponent comp){
		...
		org.primefaces.component.hotkey.Hotkey component = null;
		try {
			component = (org.primefaces.component.hotkey.Hotkey) comp;
		...
		if(_bind != null) {
			component.setValueExpression("bind", _bind);
		}
		if(_update != null) {
		...
		if(_handler != null) {
			component.setValueExpression("handler", _handler);
		}
		if(_onstart != null) {
	...
	public String getComponentType() {
		return Hotkey.COMPONENT_TYPE;
	}

	public String getRendererType() {
		return "org.primefaces.component.HotkeyRenderer";
	}
	...
	public void setBind(javax.el.ValueExpression expression){
		this._bind = expression;
	}
	...
	public void setHandler(javax.el.ValueExpression expression){
